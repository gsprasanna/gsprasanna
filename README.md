...
A passionate full stack developer from India working as **Developer** in TCS,  with a demonstrated history of working in the information technology and services industry. **Skilled in React JS, Angular, React Native, NodeJS, MongoDB, Mean Stack, RESTfull API’s** Self-motivated with the ability to swiftly master new technologies.
